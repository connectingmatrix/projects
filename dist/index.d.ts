...
export interface ProjectRuntimeQueueAdapter {
    publish?: (event: ProjectRuntimeStatus & {
        command?: string;
        payload?: unknown;
    }) => Promise<void> | void;
    subscribe?: (handler: (event: Partial<ProjectRuntimeStatus> & {
        projectId: string;
        processId: string;
        type?: ProjectRuntimeEventType;
        message?: string;
...
export interface ProjectPnpmCacheConfig {
    localDir: string;
    pvcMountDir: string;
    storeDir: string;
...
export interface SanctionedDependencyProfile {
    name: string;
    packages: string[];
    description: string;
}
export declare const SANCTIONED_DEPENDENCY_PROFILES: SanctionedDependencyProfile[];
export declare const Projects: {
    ...
    readFile(projectId: string, path: string, context?: RequestContext): ProjectFile | undefined;
    ...
    launcher: typeof import("./launcher.js").createConnectingmatrixProjectsStubLauncher;
...
export declare const graphql: {
    ...
    resolvers: {
        Query: {
            ...
            projectDependencyPlan: (_: unknown, args: {
                projectId: string;
            }, ctx: RequestContext) => string;
